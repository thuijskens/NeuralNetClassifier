...
def load_data_wrapper():
    ...
    return (to_correct_np_array(training_data), 
            to_correct_np_array(training_labels), 
            to_correct_np_array(validation_data), 
            to_correct_np_array(validation_labels), 
            to_correct_np_array(test_data), 
            to_correct_np_array(test_labels))
      

def to_correct_np_array(x):
  x = np.array(x)
  dim = x.shape
  return x.reshape(dim[0], dim[1])
